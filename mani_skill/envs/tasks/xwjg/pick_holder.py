...
@register_env("PickHolder-v1", max_episode_steps=100)
class PickHolderEnv(BaseEnv):
    ...
    def __init__(self, *args, robot_uids="rj2506", robot_init_qpos_noise=0.02, **kwargs):
        ...
        robot_cfg = ROBOT_CONFIGS[robot_uids] if robot_uids in ROBOT_CONFIGS else ROBOT_CONFIGS["rj2506"]
...
PickHolderEnv.__doc__ = PICK_HOLDER_ON_TABLE_DOC_STRING.format(robot_id="rj2506")


@register_env("PickHolderWithBaseCam-v1", max_episode_steps=100)
class PickHolderWithBaseCamEnv(PickHolderEnv):
    def __init__(self, *args, robot_uids="rj2506", robot_init_qpos_noise=0.02, **kwargs):
        robot_cfg = ROBOT_CONFIGS[robot_uids] if robot_uids in ROBOT_CONFIGS else ROBOT_CONFIGS["rj2506"]
