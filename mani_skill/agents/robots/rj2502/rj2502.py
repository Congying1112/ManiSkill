...
@register_agent()
class RJ2502(BaseAgent):
    uid = "rj2502"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/rj2502/rj2502.urdf"
    ...
    def _controller_configs(self):
        ...
        gripper_pd_joint_pos = PDJointPosMimicControllerConfig(
            ...
            mimic={"handl_joint2": {"joint": "handl_joint1"}},
        )
    ...
    def _after_init(self):
        self.finger1_link = sapien_utils.get_obj_by_name(
            self.robot.get_links(), "handl_Link1"
        )
        self.finger2_link = sapien_utils.get_obj_by_name(
            self.robot.get_links(), "handl_Link2"
        )
    ...
    def _sensor_configs(self):
        return [
            ...
            CameraConfig(
                ...
                near=0.01,
                far=100,
                mount=self.robot.links_map["head_camera_link"],
            ),
            ...
            CameraConfig(
                ...
                near=0.01,
                far=100,
                mount=self.robot.links_map["handl_camera_link"],
            ),
        ]